...
// Mapping table from Base64 characters to 6-bit nibbles.
    ...
    public  static  void  main(String[] args) throws UnsupportedEncodingException {
        String data= "张三";
        String data2="1cXI/Q==";
        System.out.println(UtileBase64.encode(data.getBytes()));
        System.out.println(UtileBase64.encode(new String(data.getBytes("GB2312"), "UTF-8").getBytes()));
        System.out.println(new String(UtileBase64.decode(data2),"GB2312"));
    }
}
